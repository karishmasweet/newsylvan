...
public class TC12 extends baseclassone
{
	@Test
	public void forgotusername_parent_enterinvalidemail() throws InterruptedException
	{
		...
		emailaddress.sendKeys("tes@yopmail.com");
		...
		Thread.sleep(5000);
		String pop=driver.findElement(By.xpath("//p[contains(text(),'User not found. Please check your email address and try again.')]")).getText();
