...
public class TC16 extends baseclassone
{
	@Test
	public void forgotpassword_tutor_enternotregistered_emailid() throws InterruptedException
	{
		...
		emailaddress.sendKeys("may@yopmail.com");
